...
public class VRPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {                      // Code to see if the VR button has been pressed
            ...
            {      // Check if Raycasts have hit something, triggering from the position of the VR Player's camera in the direction forward
               /* if (hit.transform.tag == "Enter")
                {                                     // See if anything was hit with the tag "Enter"
                ...
                {                               //  See if anything was hit with the tag "Exit"
