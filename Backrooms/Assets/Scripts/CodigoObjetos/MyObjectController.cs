...
public class MyObjectController : MonoBehaviour
{
    ...
    // across).
    public const float _minObjectDistance = 2.5f;
    public const float _maxObjectDistance = 3.5f;
    public const float _minObjectHeight = 0.5f;
    public const float _maxObjectHeight = 3.5f;
